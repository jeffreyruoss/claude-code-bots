...
- [ ] **Challenge modes** - Time trials, limited resources, etc.
- [ ] **Enemy threats** - Corrupted bots that attack your base
...
- [ ] **Recycler** - Convert buildings back to full resources
...
- [ ] **Minimap** - Overview of your factory
- [ ] **Hotbar for recipes** - Quick craft buttons
- [ ] **Notifications system** - Alerts for low power, full storage, etc.
- [ ] **Building placement preview** - Ghost showing valid/invalid placement
...
- [ ] **Screen shake** - Feedback on big events
- [ ] **Building placement animation** - Smooth drop-in effect
...
- [ ] **Performance optimization** - Object pooling, culling off-screen
- [ ] **Undo/redo system** - Ctrl+Z building placement
